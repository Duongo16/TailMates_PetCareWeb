...
export async function POST(request: NextRequest) {
  try {
    ...
    // This ensures the balance check and deduction happen in a single DB operation.
    ...
    // If updatedUser is null, it means the atomic balance check failed (race condition caught)
    if (!updatedUser) {
      return apiResponse.error(
