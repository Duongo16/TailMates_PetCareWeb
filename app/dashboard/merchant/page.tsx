...
import { Home, Package, Truck, Calendar, QrCode, Sparkles, Settings, Loader2, FileText } from "lucide-react"

type MerchantTab = "dashboard" | "products" | "services" | "orders" | "bookings" | "medical-records" | "scanner" | "settings"
