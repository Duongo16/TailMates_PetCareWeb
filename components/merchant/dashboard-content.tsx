...
const MerchantOverviewComponent = dynamic(() => import("./merchant-overview").then((mod) => mod.MerchantOverview), {
  loading: () => <div className="flex justify-center p-8"><Loader2 className="animate-spin" /></div>
})
...
export function MerchantDashboardContent({ activeTab, setActiveTab }: MerchantDashboardContentProps): React.ReactNode {
  ...
  const renderContent = () => {
    if (activeTab === "dashboard") {
      return <MerchantOverviewComponent setActiveTab={setActiveTab} />
    }
